...
set(mavlink_DIALECTS ASLUAV;AVSSUAS;all;ardupilotmega;common;cubepilot;development;icarous;matrixpilot;paparazzi;standard;storm32;uAvionix;ualberta)
set(mavlink2_DIALECTS ASLUAV;AVSSUAS;all;ardupilotmega;common;cubepilot;development;icarous;matrixpilot;paparazzi;standard;storm32;uAvionix;ualberta)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/spin/catkin_ws/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
